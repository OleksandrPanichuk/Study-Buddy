...
export class SessionSerializer extends PassportSerializer {
	...
	async serializeUser(user: TUserWithAvatar, done: (err: unknown, userId: string | null) => void) {
		try {
	...
	async deserializeUser(userId: string, done: (err: unknown, user: TUserWithAvatar | null) => void) {
		try {
