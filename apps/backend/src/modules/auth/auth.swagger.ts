...
export const ApiSignUp = () => {
	return applyDecorators(
		...
		ApiOkResponse({
			description: "User registered and signed in successfully"
		}),
		ApiConflictResponse({
			description: "Username or email already exists in the system"
		}),
		ApiBadRequestResponse({
			description: "Invalid input data - check email format, password strength, or username format"
		}),
		ApiTooManyRequestsResponse({
...
export const ApiGoogleOAuthCallback = () => {
	return applyDecorators(
		...
		ApiOkResponse({
			description: "Authentication successful - Redirects to frontend application"
		}),
		ApiBadRequestResponse({
