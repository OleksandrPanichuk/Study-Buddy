...
import type { ICreateVerificationCodeData } from "./verification-code.interfaces";
...
export class VerificationCodeRepository {
	...
	public async update(userId: string, data: Partial<Omit<ICreateVerificationCodeData, "userId">>) {
