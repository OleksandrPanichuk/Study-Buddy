...
export const sendResetPasswordTokenInputSchema = z.object({
	...
	resetPageUrl: z
		.url("Invalid url")
		.trim()
		.describe("URL of the password reset page on the client"),
});

export const resetPasswordInputSchema =
	verifyResetPasswordTokenInputSchema.extend({
...
export type TVerifyResetPasswordTokenInput = z.infer<
	typeof verifyResetPasswordTokenInputSchema
>;
export type TSendResetPasswordTokenInput = z.infer<
	typeof sendResetPasswordTokenInputSchema
>;
export type TResetPasswordInput = z.infer<typeof resetPasswordInputSchema>;

export type TVerifyResetPasswordTokenResponse = z.infer<
