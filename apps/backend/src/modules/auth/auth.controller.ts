...
import {SignInResponse, type SignUpInput, SignUpResponse} from "@/modules/auth/auth.dto";
import {
  ApiGithubOAuth,
...
import {GithubOAuthGuard, GoogleOAuthGuard, LocalAuthGuard} from "@/modules/auth/guards";
...
export class AuthController {
	...
	@Post("/sign-up")
	async signUp(@Body() dto: SignUpInput, @Req() req: Request): Promise<SignUpResponse> {
