...
import {ApiBadRequestResponse, ApiBody, ApiOkResponse, ApiOperation, ApiTooManyRequestsResponse} from "@nestjs/swagger";
import {VerifyEmailInput} from "@/modules/email-verification/email-verification.dto";
...
export const ApiVerifyEmail = () => {
	return applyDecorators(
		...
		ApiBadRequestResponse({
			description: "Email already verified | Invalid or expired verification code | Code already used"
		}),
		ApiTooManyRequestsResponse({
			description: "Too many requests - Rate limit exceeded"
		})
